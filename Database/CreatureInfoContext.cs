...
public partial class CreatureInfoContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Faction>(entity =>
        {
            ...
            entity.HasIndex(e => e.Name, "IX_Factions_Name").IsUnique();
        ...
        modelBuilder.Entity<SystemIcon>(entity =>
        {
            ...
            entity.HasIndex(e => e.ImageBytes, "IX_SystemIcons_ImageBytes").IsUnique();

            entity.HasIndex(e => e.Name, "IX_SystemIcons_Name").IsUnique();
